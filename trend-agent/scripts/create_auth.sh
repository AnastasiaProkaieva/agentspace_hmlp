...
# =============================================================================
# This script creates an OAuth 2.0 authorization for the Agent
...
DISCOVERY_ENGINE_API_BASE_URL="https://eu-discoveryengine.googleapis.com/v1alpha"
...
{
  "name": "projects/${GOOGLE_CLOUD_PROJECT}/locations/eu/authorizations/${AUTH_ID}",
  "serverSideOauth2": {
...
response=$(curl -s -w "\n%{http_code}" -X POST \
     ...
     "${DISCOVERY_ENGINE_API_BASE_URL}/projects/${GOOGLE_CLOUD_PROJECT}/locations/eu/authorizations?authorizationId=${AUTH_ID}" \
     -d "${JSON_PAYLOAD}")
